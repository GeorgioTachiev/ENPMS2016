...
%      fprintf('... iterating stations %i%s%i :: copying %s%s data\n',...
%              stn, '/', length(MyRequestedStnNames), char(FNAME), char(MyFileExtension))
...
% this should be commmented but can be used for debuging
