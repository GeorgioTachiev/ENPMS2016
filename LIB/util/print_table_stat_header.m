...
fprintf(fidTEX,'%s\n',ROW4);
ROW5 = ['\caption[Statistical parameters for stations in the vicinity of ' char(AREA) ']{Statistical parameters for stations in the vicinity of ' char(AREA) '} \label{tab:' char(AREA) '-STAT} \\'];
fprintf(fidTEX,'%s\n',ROW5);
ROW6 = ['\hline'];
fprintf(fidTEX,'%s\n',ROW6);
